...
data class Toilet(val toiletName: String? = null, val rdnmadr: String? = null, val lnmadr: String? = null, val unisexToiletYn: String? = null,
                  ...
                  val phoneNumber: String? = null, val openTime: String? = null, val latitude: String? = null, val longitude: String? = null,
    ...
    thread {
        ...
        do {
            ...
            for (i in 0 until items.length()) {
                ...
                val toilet = Toilet(obj.getString("toiletNm"), obj.getString("rdnmadr"), obj.getString("lnmadr"), obj.getString("unisexToiletYn"),
                    obj.getInt("menToiletBowlNumber"), obj.getInt("menUrineNumber"), obj.getInt("menHandicapToiletBowlNumber"),
                    obj.getInt("menHandicapUrinalNumber"), obj.getInt("menChildrenToiletBowlNumber"), obj.getInt("menChildrenUrinalNumber"),
                    obj.getInt("ladiesToiletBowlNumber"), obj.getInt("ladiesHandicapToiletBowlNumber"), obj.getInt("ladiesChildrenToiletBowlNumber"),
                    obj.getString("phoneNumber"), obj.getString("openTime"), obj.getString("latitude"), obj.getString("longitude"),
                    obj.getString("emgBellYn"), obj.getString("enterentCctvYn"), obj.getString("dipersExchgPosi"))
